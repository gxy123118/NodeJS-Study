...
// let arrayBufferBuffer = Buffer.alloc(9);


let arrayBufferBuffer1 = Buffer.from('hello world');
// let number1 = arrayBufferBuffer.write("11111111111");
//
// console.log(number1);
console.log(arrayBufferBuffer1.toJSON());

let number = arrayBufferBuffer1.readInt8(0)
let number2 = arrayBufferBuffer1.readInt16BE(0);
console.log( number);
console.log( number2);
